                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <img src="<?php echo e(URL::to('public/uploads/product/'.$pro->product_image)); ?>" height="100" width="100">
                                     ...
                                     <input type="hidden" name="tenphoto" value="<?php echo e($pro->product_image); ?>" class="form-control">
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-lab10\resources\views/admin/edit_product.blade.php ENDPATH**/ ?>